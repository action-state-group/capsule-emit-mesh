...
**Rung 2+ — config, identity, and binary attestation (B5b).** The red-team of the
rungs stacked on top of this ledger — model-id spoof, quant swap, hardware fake,
self-measured binary tamper, and owner-binding — has moved to its own file:
[`REDTEAM-RUNG2.md`](REDTEAM-RUNG2.md).
